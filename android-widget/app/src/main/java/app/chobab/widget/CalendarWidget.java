...
public class CalendarWidget extends AppWidgetProvider {
 ...
 protected String mode(){return "upcoming";}
 ...
 static PendingIntent open(Context c,String url,int id){return PendingIntent.getActivity(c,id,new Intent(Intent.ACTION_VIEW,Uri.parse(url)),PendingIntent.FLAG_UPDATE_CURRENT|PendingIntent.FLAG_IMMUTABLE);}
 ...
 void update(Context context){
  ...
  try{
   ...
   if(mode.equals("month"))renderMonth(context,views,events,origin);
